...
namespace TerrariaFortress.Items
{
    public class NoiseMakerBirthday : TFItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            {
                Dust dust2 = Dust.NewDustPerfect(player.MountedCenter + new Vector2(0f, Main.rand.Next(-8, 9)), ModContent.DustType<BirthdayBalloon>(), new Vector2(i % 2 == 0 ? Main.rand.NextFloat(1f, 7f) : Main.rand.NextFloat(-7f, 1f), 0f), 0, default, 1f);
            }
